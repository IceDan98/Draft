// script.js v10.0 - Applied changes from TZ v1: Removed themes, updated homeTitle
document.addEventListener('DOMContentLoaded', () => {
    // Увеличиваем номер версии для отслеживания изменений
    console.log("DOM Fully Loaded. Initializing App v10.0..."); // Version Updated

    // --- Language State & Translations ---
    let currentLanguage = localStorage.getItem('language') || 'ru';
    const translations = {
        ru: {
            // UPDATED: Changed homeTitle text and added <br>
            ...
            // REMOVED: Theme settings translations
    ...
    // REMOVED: currentTheme variable (defaulting to dark)
    ...
    function updateUIText(lang) {
        ...
        elements.forEach(el => {
            ...
            // UPDATED: Use innerHTML for homeTitle to render <br> tag
            if (key === 'homeTitle') {
    ...
    function updateSettingsUI() {
        ...
        // REMOVED: Theme setting UI update
        /*
