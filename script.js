// script.js v7.4 - Restore Priority Filter Listener
document.addEventListener('DOMContentLoaded', () => {
    console.log("DOM Fully Loaded. Initializing App v7.4..."); // Version Updated
    ...
    // console.log("DEBUG: Theme Toggle Button Element:", themeToggleButton); // Keep for now
    ...
    async function initializeAppDraft() {
        ...
        try {
            ...
            // FIX: Attach listener for priority filter button here
            if (priorityFilterButton) {
                 console.log("DEBUG: Attaching click listener to priorityFilterButton");
            ...
            // --- Reverted: Attach listeners individually for role filters ---
            if (filterButtons) {
                filterButtons.forEach((button, index) => {
                    if (button) {
                        // Check if listener already exists? No, just re-attach for simplicity here.
