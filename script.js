// script.js v7.0 - Theme Toggle Added
document.addEventListener('DOMContentLoaded', () => {
    console.log("DOM Fully Loaded. Initializing App v7.0..."); // Version Updated
    ...
    let loadingIndicator, mainLayout, championGridElement, startButton, resetButton, undoButton, timerDisplay, championSearch, bluePicksContainer, redPicksContainer, blueColumn, redColumn, swapButton, clearPicksButton, toggleTimerButton, roleFilterButtonsContainer, confirmPickBanButton, priorityFilterButton, nextDraftButton, globallyBannedDisplay, globalBansBlueContainer, globalBansRedContainer, championTooltip, statusMessage, blueTeamNameH2, redTeamNameH2, blueScoreEl, redScoreEl, returnHomeButton;
    ...
    function navigateTo(pageName) {
        ...
        if (pageName === 'home') {
            ...
            if(adminButton) adminButton.classList.remove('hidden'); // Show on home
            if(themeToggleButton) themeToggleButton.classList.remove('hidden'); // Show on home
            ...
            // Buttons are hidden by default when navigating away from home
    ...
    async function initializeAppDraft() {
        ...
        try {
            ...
            // --- Event Delegation for Role Filters (Listener attached on DOM load now) ---
            if (roleFilterButtonsContainer) {
                 console.log("DEBUG: Delegated click listener already attached to #roleFilterButtons");
            } else {
                console.warn("Role filter container not found in initializeAppDraft");
            }
